...
{
    createButton("button_home.png", {15, 10}, std::bind(&SettingScreen::goToMenu, this));
    createButton("Easy.png", {555, 200 + 40}, std::bind(&SettingScreen::select4x4, this));
    createButton("Moderate.png", {555, 300}, std::bind(&SettingScreen::select6x6, this));
    createButton("Difficult.png", {555, 400 - 40}, std::bind(&SettingScreen::select6x8, this));
}
